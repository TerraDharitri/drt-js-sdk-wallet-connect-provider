...
The available Dharitri JSON-RPC Methods and the structure can be checked on WalletConnect's [Specs](https://specs.walletconnect.com/2.0/blockchain-rpc/dharitri-rpc) and on [Dharitri Docs](https://docs.dharitri.org/integrators/walletconnect-json-rpc-methods).
